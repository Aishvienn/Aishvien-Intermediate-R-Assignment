...
roll_dice2 <- function(d = 20, num_rolls) {
  ...
  print(glue("You rolled {num_rolls} d{d} dice: {paste(rolls, collapse = ', ')}. Sum: {sum(rolls)}"))
if(d < 0 ) warning("Please input a positive integer")
if(num_rolls < 0) warning("Please input a positive integer")
  
  return(rolls)
}

print(roll_dice2(10,2))
```
